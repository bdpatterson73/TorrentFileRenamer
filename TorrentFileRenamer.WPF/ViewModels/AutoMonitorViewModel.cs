...
public class AutoMonitorViewModel : ViewModelBase
{
    ...
    public AutoMonitorViewModel(FolderMonitorService folderMonitorService, AppSettings appSettings)
    {
        ...
        {
            WpfApplication.Current.Dispatcher.BeginInvoke(new Action(() => { StartMonitoring(); }), System.Windows.Threading.DispatcherPriority.ApplicationIdle);
        }
    }
    ...
    {
        WpfApplication.Current.Dispatcher.Invoke(() => { StatusMessage = status; });
    }
